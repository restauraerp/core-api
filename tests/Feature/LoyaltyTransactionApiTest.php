...
class LoyaltyTransactionApiTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_loyalty_transactions_index_requires_auth()
    {
    ...
    public function test_loyalty_transactions_index_returns_200_for_authenticated_user()
    {
