...
class RecipeIngredientApiTest extends TestCase
{
    ...
    public function test_recipe_ingredients_index_requires_auth()
    {
        $response = $this->getJson('/api/v1/recipe-ingredients');
        // Some endpoints like locations might be public, others protected
        $this->assertContains($response->status(), [200, 401]);
    }

    public function test_recipe_ingredients_index_returns_200_for_authenticated_user()
    {
