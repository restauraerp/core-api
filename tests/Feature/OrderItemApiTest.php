...
class OrderItemApiTest extends TestCase
{
    ...
    public function test_order_items_index_requires_auth()
    {
        $response = $this->getJson('/api/v1/order-items');
        // Some endpoints like locations might be public, others protected
        $this->assertContains($response->status(), [200, 401]);
    }

    public function test_order_items_index_returns_200_for_authenticated_user()
    {
