...
class CctvCameraApiTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_cctv_cameras_index_requires_auth()
    {
        $response = $this->getJson('/api/v1/cctv-cameras');
        // Some endpoints like locations might be public, others protected
        $this->assertContains($response->status(), [200, 401]);
    }

    public function test_cctv_cameras_index_returns_200_for_authenticated_user()
    {
