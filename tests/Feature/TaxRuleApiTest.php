...
class TaxRuleApiTest extends TestCase
{
    ...
    public function test_tax_rules_index_requires_auth()
    {
        $response = $this->getJson('/api/v1/tax-rules');
        // Some endpoints like locations might be public, others protected
        $this->assertContains($response->status(), [200, 401]);
    }

    public function test_tax_rules_index_returns_200_for_authenticated_user()
    {
